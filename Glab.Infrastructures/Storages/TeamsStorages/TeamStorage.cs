...
public class TeamStorage : ITeamStorage
{
    ...
    private const string insertTeamQuery = "Insert into dbo.Teams(TeamId, Status, LaboratoryId, TeamName, TeamAcronyme ,TeamLeaderId) VALUES(@aTeamId, @aStatus, @aLaboratoryId, @aTeamName ,@aTeamAcronyme ,@aTeamLeaderId)";
    ...
    public async Task InsertTeam(Team team)
    {
        ...
        cmd.Parameters.AddWithValue("@aStatus",0);
        ...
        cmd.Parameters.AddWithValue("@aTeamLeaderId", team.TeamLeaderId);
